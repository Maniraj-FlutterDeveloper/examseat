                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                                    ...
                                    <div class="mb-3 row align-items-center">
                                        <div class="col-auto">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="correct_answer" value="{{ $i }}" id="option_correct_{{ $i }}" {{ old('correct_answer') == $i ? 'checked' : '' }}>
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" name="options[]" placeholder="Option {{ $i + 1 }}" value="{{ old('options.' . $i) }}">
                                        </div>
                                        @if($i > 1)
                                            <div class="col-auto">
                        ...
                        <div id="true_false_options" class="question-options" style="display: none;">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="true_false_answer" value="1" id="true_option" {{ old('true_false_answer') == '1' ? 'checked' : '' }}>
                                <label class="form-check-label" for="true_option">
                                    True
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="true_false_answer" value="0" id="false_option" {{ old('true_false_answer') == '0' ? 'checked' : '' }}>
                        ...
                        <div id="fill_in_the_blank_options" class="question-options" style="display: none;">
                            ...
                            <div class="blanks-container">
                                @for($i = 0; $i < 3; $i++)
                                    <div class="mb-3 row align-items-center">
                                        <div class="col">
                                            <input type="text" class="form-control" name="blank_answers[]" placeholder="Correct Answer {{ $i + 1 }}" value="{{ old('blank_answers.' . $i) }}">
                                        </div>
                                        @if($i > 0)
                                            <div class="col-auto">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="column-a-container">
                                        @for($i = 0; $i < 4; $i++)
                                            <div class="mb-3 row align-items-center">
                                                <div class="col">
                                                    <input type="text" class="form-control" name="column_a[]" placeholder="Item {{ $i + 1 }}" value="{{ old('column_a.' . $i) }}">
                                                </div>
                                                @if($i > 1)
                                                    <div class="col-auto">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="column-b-container">
                                        @for($i = 0; $i < 4; $i++)
                                            <div class="mb-3">
                                                <input type="text" class="form-control" name="column_b[]" placeholder="Match {{ $i + 1 }}" value="{{ old('column_b.' . $i) }}">
                                                <input type="hidden" name="matching_answers[]" value="{{ $i }}">
                                            </div>
                                        @endfor
                                    </div>
                                </div>
                        ...
                        <div id="text_answer_options" class="question-options" style="display: none;">
                            ...
                            <textarea class="form-control" id="model_answer" name="model_answer" rows="4">{{ old('model_answer') }}</textarea>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <select class="form-select @error('unit_id') is-invalid @enderror" id="unit_id" name="unit_id" required>
                                    ...
                                    @if(old('subject_id') || request('subject_id'))
                                        @foreach($units->where('subject_id', old('subject_id', request('subject_id'))) as $unit)
                                            <option value="{{ $unit->id }}" {{ old('unit_id', request('unit_id')) == $unit->id ? 'selected' : '' }}>
                                                {{ $unit->unit_name }}
                                            </option>
                                        @endforeach
                                    @endif
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <select class="form-select @error('topic_id') is-invalid @enderror" id="topic_id" name="topic_id" required>
                                    ...
                                    @if(old('unit_id') || request('unit_id'))
                                        @foreach($topics->where('unit_id', old('unit_id', request('unit_id'))) as $topic)
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('marks') is-invalid @enderror" id="marks" name="marks" value="{{ old('marks', 1) }}" min="1" max="100" required>
                            @error('marks')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
