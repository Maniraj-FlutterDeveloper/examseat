                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        @error('roll_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="form-text">Enter a unique roll number for the student</div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        @error('section')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="form-text">e.g., A, B, C, etc.</div>
                    </div>
                </div>
                
                <div class="mb-3">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="has_disability" name="has_disability" value="1" {{ old('has_disability') ? 'checked' : '' }}>
                        <label class="form-check-label" for="has_disability">Student has disability</label>
                    </div>
                </div>
                
                <div class="mb-3" id="disability_details_container" style="{{ old('has_disability') ? '' : 'display: none;' }}">
                    <label for="disability_details" class="form-label">Disability Details</label>
                    <textarea class="form-control @error('disability_details') is-invalid @enderror" id="disability_details" name="disability_details" rows="3">{{ old('disability_details') }}</textarea>
                    @error('disability_details')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <div class="form-text">Provide details about the disability to ensure appropriate accommodations</div>
                </div>
