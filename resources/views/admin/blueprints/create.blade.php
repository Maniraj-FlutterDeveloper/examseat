...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="page-title">Create New Blueprint</h1>
        <a href="{{ route('admin.blueprints.index') }}" class="btn btn-secondary">
            <i class="fas fa-arrow-left me-2"></i>Back to Blueprints
        </a>
    </div>
    
    <form action="{{ route('admin.blueprints.store') }}" method="POST" id="blueprintForm">
        @csrf
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Save Blueprint
                            </button>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card mt-4">
                            <div class="card-body bg-light">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h6>Total Questions: <span id="totalQuestions">0</span></h6>
                                    </div>
                                    <div class="col-md-6">
                                        <h6>Total Marks: <span id="calculatedMarks">0</span> / <span id="requiredMarks">100</span></h6>
                                        <div class="progress mt-2">
                                            <div class="progress-bar" id="marksProgressBar" role="progressbar" style="width: 0%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">0%</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function removeSection(sectionElement) {
            ...
            if (sectionsContainer.querySelectorAll('.section-card').length === 0) {
        ...
        function validateBlueprint() {
            ...
            alert('Blueprint validation successful! You can now save the blueprint.');
        }
