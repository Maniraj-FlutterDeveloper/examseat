        ...
        <div class="card-body">
            <form action="{{ route('questions.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select @error('unit_id') is-invalid @enderror" id="unit_id" name="unit_id" required>
                            ...
                            @if(old('subject_id'))
                                @foreach($units->where('subject_id', old('subject_id')) as $unit)
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select @error('topic_id') is-invalid @enderror" id="topic_id" name="topic_id" required>
                            ...
                            @if(old('unit_id'))
                                @foreach($topics->where('unit_id', old('unit_id')) as $topic)
                                    <option value="{{ $topic->id }}" {{ old('topic_id', request('topic_id')) == $topic->id ? 'selected' : '' }}>
                                        {{ $topic->topic_name }}
                                    </option>
                                @endforeach
                            @elseif(request('topic_id'))
                                @foreach($topics->where('id', request('topic_id')) as $topic)
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select class="form-select @error('question_type') is-invalid @enderror" id="question_type" name="question_type" required>
                            ...
                            <option value="fill_in_the_blank" {{ old('question_type') == 'fill_in_the_blank' ? 'selected' : '' }}>Fill in the Blank</option>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select @error('blooms_taxonomy_id') is-invalid @enderror" id="blooms_taxonomy_id" name="blooms_taxonomy_id" required>
                            ...
                            @foreach($bloomsTaxonomies as $taxonomy)
                                <option value="{{ $taxonomy->id }}" {{ old('blooms_taxonomy_id', request('blooms_taxonomy_id')) == $taxonomy->id ? 'selected' : '' }}>
                                    {{ $taxonomy->level_name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('marks') is-invalid @enderror" id="marks" name="marks" value="{{ old('marks') }}" min="1" required>
                    @error('marks')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div id="mcq_options" class="question-type-fields" style="{{ old('question_type') == 'mcq' ? '' : 'display: none;' }}">
                ...
                <div id="true_false_options" class="question-type-fields" style="{{ old('question_type') == 'true_false' ? '' : 'display: none;' }}">
                ...
                <div id="short_answer_options" class="question-type-fields" style="{{ old('question_type') == 'short_answer' ? '' : 'display: none;' }}">
                    <h5 class="mt-4 mb-3">Short Answer</h5>
                    <div class="mb-3">
                        <label for="short_answer" class="form-label">Model Answer <span class="text-danger">*</span></label>
                        <textarea class="form-control @error('short_answer') is-invalid @enderror" id="short_answer" name="short_answer" rows="2">{{ old('short_answer') }}</textarea>
                        @error('short_answer')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div id="long_answer_options" class="question-type-fields" style="{{ old('question_type') == 'long_answer' ? '' : 'display: none;' }}">
                    <h5 class="mt-4 mb-3">Long Answer</h5>
                    <div class="mb-3">
                        <label for="long_answer" class="form-label">Model Answer</label>
                        <textarea class="form-control @error('long_answer') is-invalid @enderror" id="long_answer" name="long_answer" rows="4">{{ old('long_answer') }}</textarea>
                        @error('long_answer')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('marking_scheme') is-invalid @enderror" id="marking_scheme" name="marking_scheme" rows="3" placeholder="Describe how marks should be allocated">{{ old('marking_scheme') }}</textarea>
                ...
                <div id="fill_in_the_blank_options" class="question-type-fields" style="{{ old('question_type') == 'fill_in_the_blank' ? '' : 'display: none;' }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('blank_answer') is-invalid @enderror" id="blank_answer" name="blank_answer" value="{{ old('blank_answer') }}">
                ...
                <div id="matching_options" class="question-type-fields" style="{{ old('question_type') == 'matching' ? '' : 'display: none;' }}">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('explanation') is-invalid @enderror" id="explanation" name="explanation" rows="3" placeholder="Explain the answer or provide additional context">{{ old('explanation') }}</textarea>
                    @error('explanation')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
