...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0 text-gray-800">Create Unit for {{ $subject->name }}</h1>
</div>
...
<div class="card shadow fade-in">
    ...
    <div class="card-body">
        <form action="{{ route('question-bank.subjects.units.store', $subject) }}" method="POST">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('order') is-invalid @enderror" id="order" name="order" value="{{ old('order', $maxOrder + 1) }}" min="1">
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('question-bank.subjects.show', $subject) }}" class="btn btn-secondary me-2">
