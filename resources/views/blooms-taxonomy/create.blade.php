...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('blooms-taxonomy.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('example_verbs') is-invalid @enderror" id="example_verbs" name="example_verbs" rows="3" placeholder="Enter comma-separated verbs (e.g., define, list, recall)">{{ old('example_verbs') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('level_order') is-invalid @enderror" id="level_order" name="level_order" value="{{ old('level_order') }}" min="1" required>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        You can add custom levels beyond the standard taxonomy if needed for your specific educational context.
                    </div>
                </div>
            </div>
        </div>
