        ...
        <div class="card-body">
            <form action="{{ route('students.store') }}" method="POST">
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" class="form-check-input @error('has_special_needs') is-invalid @enderror" id="has_special_needs" name="has_special_needs" value="1" {{ old('has_special_needs') ? 'checked' : '' }}>
                ...
                <div class="mb-3" id="special_needs_details_container" style="{{ old('has_special_needs') ? '' : 'display: none;' }}">
